...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libxc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libxc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libxc libxc-c pylibxc
# for installing globally
pixi global install libxc libxc-c pylibxc
```
...
It is possible to list all of the versions of `libxc` available on your platform:
...
```
pixi search libxc --channel conda-forge
```
